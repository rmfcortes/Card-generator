...
export class ThemeService {
  ...
  setAppTheme(profile: MainProfile) {
    ...
    profile.colors.employment ? themeWrapper.style.setProperty('--employmentColor', profile.colors.employment) : themeWrapper.style.setProperty('--employmentColor', 'black')
    ...
    profile.colors.textButtons ? themeWrapper.style.setProperty('--buttonsTextColor', profile.colors.textButtons) : themeWrapper.style.setProperty('--buttonsTextColor', 'black')
    ...
    profile.colors.iconHomeTab ? themeWrapper.style.setProperty('--iconHomeColor', profile.colors.iconHomeTab) : themeWrapper.style.setProperty('--iconHomeColor', 'black')
    ...
    profile.colors.iconsTabsFocused ? themeWrapper.style.setProperty('--iconsTabsFocused', profile.colors.iconsTabsFocused) : themeWrapper.style.setProperty('--iconsTabsFocused', 'black')
    ...
    profile.colors.segmentButtonFocused ? themeWrapper.style.setProperty('--segmentButtonFocusedColor', profile.colors.segmentButtonFocused) : themeWrapper.style.setProperty('--segmentButtonFocusedColor', 'black')
    ...
    profile.colors.descriptionProduct ? themeWrapper.style.setProperty('--descripProdColor', profile.colors.descriptionProduct) : themeWrapper.style.setProperty('--descripProdColor', 'black')
    ...
    profile.colors.backgroundCard ? themeWrapper.style.setProperty('--backgroundCardColor', profile.colors.backgroundCard) : themeWrapper.style.setProperty('--backgroundCardColor', 'black')
  }
