...
export class ThemeService {
  ...
  setAllFonts(font: string) {
    document.querySelector('body').style.setProperty('--fontName', font)
    document.querySelector('body').style.setProperty('--fontEmployment', font)
    document.querySelector('body').style.setProperty('--fontContact', font)
    document.querySelector('body').style.setProperty('--fontSegment', font)
    document.querySelector('body').style.setProperty('--fontHeader', font)
    document.querySelector('body').style.setProperty('--fontProductName', font)
    document.querySelector('body').style.setProperty('--fontDescription', font)
    document.querySelector('body').style.setProperty('--fontPrice', font)
  }
