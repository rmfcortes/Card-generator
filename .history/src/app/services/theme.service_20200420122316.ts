...
export class ThemeService {
  ...
  setAppTheme(colors: Colors, src: string) {
    ...
    if (colors.background && src === 'background' || src === 'all') {
    ...
    if (src === 'address' || src === 'all') colors.address ? themeWrapper.style.setProperty('--adressColor', colors.address) : themeWrapper.style.setProperty('--adressColor', 'black')
