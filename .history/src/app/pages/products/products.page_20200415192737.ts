  ...
  setSegementColors() {
    setTimeout(() => {      
      ...
      segments.forEach((f: any) => {
        f.style.setProperty('--color', this.profile.colors.segmentButton)
        f.style.setProperty('--color-checked', this.profile.colors.segmentButtonFocused)
        f.style.setProperty('--color-focused', this.profile.colors.segmentButtonFocused)
      })
