...
import { ValidateEmailNotTaken } from '../../../../.history/src/app/validators/unique_email.validator_20200413124426';
...
export class LoginPage implements OnInit {
  ...
  setSignUpForm() {
    ...
    this.validation_signUp_messages = {
      ...
      console.log(this.validation_signUp_messages);
  }

  // validateEmailNotTaken(control: AbstractControl) {
  //   return this.userService.checkEmailNotTaken(control.value).then(res => {
