...
export class HomePage implements OnInit {
  ...
  setBackground(color) {
    this.profile.colors.backgroundCard = color
    this.setTheme()
  }

  setBackgroundGradient() {
    this.profile.colors.background = `linear-gradient(${this.gradientDirection}, ${this.profile.colors.background} 0%, ${this.profile.colors.backgroundGradient} 100%)`
    this.setTheme()
  }
